...
public class MacroRotateTest
{
    public MacroRotateTest()
    {
    ...
    public void MacroExecutesAndReturnsCommand()
    {
        ...
        IoC.Resolve<Hwdtech.ICommand>("IoC.Register", "Specs.Rotate", (object[] args) => new string[] { "A" }).Execute();
        ...
        IoC.Resolve<Hwdtech.ICommand>("Macro.Rotate").Execute();
    ...
    public void SpecsNotSpecifiedAndThrowsException()
    {
        ...
        Assert.Throws<ArgumentException>(() => IoC.Resolve<Hwdtech.ICommand>("Macro.Rotate").Execute());
    }
}
